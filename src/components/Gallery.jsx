    ...
    <>
      <section id="gallery" className="zn-section zn-gallery">
        <div className="zn-section-head">
          <p>Gallery</p>
          <h2>Inside O3 spa and salon</h2>
          <span />
          <p className="zn-gallery-subtitle">Step inside O3 spa and salon and experience luxury redefined.</p>
        </div>

        <div className="zn-gallery-grid">
          {galleryImages.map((image, index) => (
            <div className="zn-gallery-item" key={image}>
              <img src={image} alt={`O3 Spa and Salon Gallery ${index + 1}`} />
            </div>
          ))}
        </div>
      </section>
