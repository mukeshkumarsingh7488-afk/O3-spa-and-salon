...
export default function Contact() {
  ...
  const googleMapOpenUrl = `https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(BUSINESS.mapQuery || BUSINESS.address)}`;
        ...
        <div className="zn-contact-grid">
          <div className="zn-contact-info">
            <div className="zn-contact-card">
              <h3>Visit Our Spa</h3>
              <a href={googleMapOpenUrl} target="_blank" rel="noopener noreferrer">
                {BUSINESS.address}
              </a>
            </div>
